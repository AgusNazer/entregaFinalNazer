...
const [buyer, setBuyer] = useState({})
    ...
    if(load){
        ...
        return (
            <>
            {orderID ? <div>
                <h2 className='font-bold font-[popins]'>Thanks for buying, your order is: {orderID.id}</h2>
                <Link to='/entregaFinalNazer/' className=" m-2 bg-blue-400 btn hover:bg-blue-600 hover:text-white border-none py-2 px-4 rounded-full uppercase font-[popins]"> Back to shop </Link>
